...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='axel_utility_token.conf'
CONFIGFOLDER='/root/.axel_utility_token'
COIN_DAEMON='axel_utility_tokend'
COIN_CLI='axel_utility_token-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ='https://github.com/axelnetwork/AXEL-Utility-Token/releases/download/v1.0.0.0/AXEL_Utility_Token-1.0.0.0-daemon_ubuntu_16.04.tar.gz'
COIN_ZIP=$(echo $COIN_TGZ | awk -F'/' '{print $NF}')
COIN_NAME='axel_utility_token'
COIN_PORT=15319
RPC_PORT=15318
...
function download_node() {
  ...
  wget -q $COIN_TGZ
  tar xzvf AXEL_Utility_Token-1.0.0.0-daemon_ubuntu_16.04.tar.gz
  cd rev >/dev/null 2>&1
...
addnode=207.148.5.7
addnode=202.182.115.228
addnode=45.76.177.40
addnode=95.179.184.212
addnode=104.238.177.76
addnode=45.77.56.81
addnode=45.63.64.137
addnode=149.28.164.102
...
function important_information() {
 ...
 echo -e "${BLUE}================================================================================================================================"
 echo -e "${CYAN}Follow twitter to stay updated.  https://twitter.com/axelunlimited${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${CYAN}Ensure Node is fully SYNCED with BLOCKCHAIN.${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
 echo -e "${GREEN}Usage Commands.${NC}"
 echo -e "${GREEN}axel_utility_token-cli masternode status${NC}"
 echo -e "${GREEN}axel_utility_token-cli getinfo${NC}"
 echo -e "${BLUE}================================================================================================================================${NC}"
